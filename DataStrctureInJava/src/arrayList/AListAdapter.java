...
public abstract class AListAdapter<E>  implements List<E>, Cloneable, RandomAccess, Serializable {
//    dummy class implements all the relevant interfaces and member functions
//    that ArrayList implements, but with implementation functions which effectively say "not implemented."
